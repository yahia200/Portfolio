...
let s = [`transition-all duration-[3000ms] bg-ctp-mantle h-[100%] ${verticalDisplay ? "" : "rounded-3xl"} flex justify-center flex-col items-center shadow-inner ${verticalDisplay ? "bg-[radial-gradient(#f5e0dc65_6px,#181825_1px)]" : "bg-[radial-gradient(#f5e0dc50_4px,#181825_1px)]"} bg-[size:72px_72px] bg-[center_top_0px]`,
