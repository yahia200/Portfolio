...
function NavBar() {
  ...
  <motion.nav initial="hiddenMenu" animate="visable" variants={defaultAnimation} transition={{duration: 0.05}} className="bg-red-500">
  ...
  return (
    ...
    <motion.div
    className="bg-ctp-base absolute top-[3vw] rounded-2xl h-fit font-bold min-h-10"
    ...
    >
      {verticalDisplay && <motion.div
        ...
        transition={{delay: delay*4}}
          ...
          className="absolute right-0 z-[115] bottom-0 transform -translate-y-1/2"
          alt="logo">
